...
date: "Edited: `r format(Sys.time(),'%x %X %Z')`"
output: 
  html_document: 
...
```{r map line example,echo=FALSE,warning=FALSE}
...
echartR(airquality, y=~Temp, type='histogram', splitNumber=13,
        ...
        subtitle = '(source: airquality)', xAxis=list(rotate=45))
```
