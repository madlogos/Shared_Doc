...
- markLine: 显示标线，默认不显示。格式写作一个列表 Show markline, default to NULL. The grammar is a list:
    - 缩略格式 Short form：list(c('data series 1 name|index','min|max|average'),c('data series 2 name|index','min|max|average'),...)。如list('male','average')或list(1,'average')都可表示male数据系列平均值标线，只用于line, bar, scatter。E.g., both list('male','average') and list(1,'average') could refer to an average markline of the series 'male', only available for line, bar, scatter charts.
